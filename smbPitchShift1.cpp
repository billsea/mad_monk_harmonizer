 ...
 *change
 * the pitch. numSampsToProcess tells the routine how many samples in
 *indata[0...
 * numSampsToProcess-1] should be pitch shifted and moved to outdata[0 ...
 * numSampsToProcess-1]. The two buffers can be identical (ie. it can process
 *the
...
void smbFft1(float *fftBuffer, long fftFrameSize, long sign);
double smbAtan21(double x, double y);
 ...
 */
{
	...
	for (i = 0; i < numSampsToProcess; i++){
		...
		if (gRover >= fftFrameSize) {
			...
			/* ***************** ANALYSIS ******************* */
			/* do transform */
			smbFft1(gFFTworksp, fftFrameSize, -1);
